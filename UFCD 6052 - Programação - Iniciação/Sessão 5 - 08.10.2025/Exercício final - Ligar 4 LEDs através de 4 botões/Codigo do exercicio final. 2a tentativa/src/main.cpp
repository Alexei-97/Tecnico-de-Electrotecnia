...
void loop()
{
  ...
  //Se estiver pressionado só o botão do LED azul...
  ...
  //...então realiza-se o caso 2
  {
    ...
    switch (opcao)
    {
      ...
      //Caso 2: Se estiver pressionado só o botão do LED azul...
      case 2:
      //...liga-se só o LED azul
      digitalWrite(led_branco, LOW);
      digitalWrite(led_azul, HIGH);
      digitalWrite(led_verde, LOW);
      digitalWrite(led_vermelho, LOW);
      //E aparece a informação no monitor
      Serial.println("Botão de baixo pressionado - LED azul ligado");
      break;
    }
}